...
const bc1 = {
  chain: [
    ...
    },
    {
      ...
      previousBlockHash:
        "0000c09685e31e57318e569b5fe3ca88ced727a29a0eb9cbea633e05056b4c29",
    },
    {
      index: 5,
      ...
      previousBlockHash:
        "00001f3f4e1635cc930cdc41a954d19bcf457eeba8bf6c7be7aa4fe1489e64d3",
    },
    {
      index: 6,
      ...
      transactions: [
        ...
        },
        {
          ...
          sender: "NNFANSDFHYHTN90A09SNFAS",
          recipient: "555dc5d04e4c11e89b44174d1b876bbf",
          transactionId: "c00a6f704e4c11e89b44174d1b876bbc",
        },
      ],
      nonce: 252386,
      hash: "0000462c88b2814ebb930b13ac3c19dc698b2dca27b0c296e03f8a2ea104f74f",
      previousBlockHash:
        "000067295fb567842799b887910fe31cc8ca7544ec15a000b65005f6ac50df21",
    },
  ],
  pendingTransactions: [
    {
...
bitcoin.chain = bc1.chain;

console.log("VALID: ", bitcoin.chainIsValid(bc1.chain));

// 잔액 조회 테스트
const testAddress = "555dc5d04e4c11e89b44174d1b876bbf";

const requestOptions = {
  uri: `http://localhost:3001/address/${testAddress}`,
  method: "GET",
  json: true,
};
